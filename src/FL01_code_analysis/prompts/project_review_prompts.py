...
# Import central types directly
from sourcelens.core.common_types import (
    CodeAbstractionsList,
    CodeRelationshipsDict,
    FilePathContentList,  # Previously FileDataList
)

# Local TypeAliases if specific structure is needed here,
# but prefer using central types if they match.
# FileDataList: TypeAlias = FilePathContentList # Example if aliasing
...
class ProjectReviewPrompts:
    ...
    def _format_relationships_for_prompt(
        ...
        # Assuming details are CodeRelationshipDetailItem from common_types
    ...
    def format_project_review_prompt(
        project_name: str,
        abstractions_data: CodeAbstractionsList,  # Use central type
        relationships_data: CodeRelationshipsDict,  # Use central type
        files_data: FilePathContentList,  # Use central type
        language: str,
    ) -> str:
