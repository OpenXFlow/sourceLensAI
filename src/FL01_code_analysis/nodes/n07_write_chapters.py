...
# ChapterOrderListInternal zostáva ako list[int], čo je štandardný typ
...
class WriteChapters(BaseBatchNode[WriteChapterPreparedItem, SingleChapterExecutionResult]):
    ...
    def _prepare_chapter_metadata(
        ...
        for i, abstraction_index in enumerate(chapter_order):
            ...
            chapter_num = i + 1
            abstraction_item: dict[str, Any] = abstractions[abstraction_index]  # Using CodeAbstractionItem from list
            ...
            metadata: ChapterMetadata = {  # Using ChapterMetadata type
                "num": chapter_num,
                "name": chapter_name,
                "filename": filename,
    ...
    def _prepare_single_chapter_item(
        ...
        files_data: OptionalFilePathContentList,  # Použitie OptionalFilePathContentList
        project_name: str,
        chapter_metadata_map: dict[int, ChapterMetadata],  # Použitie ChapterMetadata
        ...
        Args:
            ...
            chapter_metadata_map: A map from abstraction_index to `ChapterMetadata`.
        ...
        """
        abstraction_details: dict[str, Any] = abstractions[abstraction_index]
        ...
        files_data_for_context: FilePathContentList = []  # Použitie FilePathContentList
        ...
        prev_chapter_meta: Optional[ChapterMetadata] = None  # Použitie ChapterMetadata
        ...
        next_chapter_meta: Optional[ChapterMetadata] = None  # Použitie ChapterMetadata
        ...
        current_chapter_metadata: ChapterMetadata = chapter_metadata_map[abstraction_index]  # Použitie ChapterMetadata
    ...
    def pre_execution(self, shared_context: SLSharedContext) -> Iterable[WriteChapterPreparedItem]:
        ...
        try:
            ...
            files_data: OptionalFilePathContentList = files_data_any if isinstance(files_data_any, list) else []
