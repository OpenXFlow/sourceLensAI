...
from sourcelens.core.common_types import CodeAbstractionsList, CodeRelationshipsDict
...
class OrderChapters(BaseNode[OrderChaptersPreparedInputs, OrderChaptersExecutionResult]):
    ...
    def _build_order_chapters_context(
        self, abstractions: CodeAbstractionsList, relationships: CodeRelationshipsDict, language: str
    ) -> tuple[str, str, str]:
        ...
        summary_raw_any: Any = relationships.get("overall_summary", "N/A")  # Ensure "overall_summary" key
        ...
        rel_details_raw_any: Any = relationships.get("details", [])  # Ensure "details" key
        ...
        for rel_any in rel_details_list_any:
            if not isinstance(rel_any, dict):
                ...
                continue
            rel: dict[str, Any] = rel_any  # Type assertion
    ...
    def pre_execution(self, shared_context: SLSharedContext) -> OrderChaptersPreparedInputs:
        ...
        relationships: CodeRelationshipsDict = relationships_any if isinstance(relationships_any, dict) else {}
...
# End of src/FL01_code_analysis/nodes/n04_order_chapters.py
