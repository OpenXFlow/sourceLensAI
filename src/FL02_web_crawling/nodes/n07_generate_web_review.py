...
class GenerateWebReview(BaseNode[WebReviewPreparedInputs, WebReviewExecutionResult]):
    ...
    def _format_review_yaml_to_markdown(self, review_data: dict[str, Any], collection_name: str) -> str:
        ...
        Args:
            ...
            collection_name: The name of the document collection (e.g., website name).

        Returns:
            A string containing the formatted Markdown for the web content review.
        """
    ...
    def pre_execution(self, shared_context: SLSharedContext) -> WebReviewPreparedInputs:
        ...
        try:
            ...
            inventory_any: Any = shared_context.get("content_inventory_md")  # This is inventory of chunks now
            ...
            prepared_inputs: WebReviewPreparedInputs = {
                ...
                "concepts_data": concepts_data,  # Concepts derived from chunks
                "relationships_data": relationships_data,  # Relationships between chunk-derived concepts
                "inventory_content": inventory_content,  # Inventory of chunks
    ...
    def execution(self, prepared_inputs: WebReviewPreparedInputs) -> WebReviewExecutionResult:
        ...
        Returns:
            Markdown content of the review, or None/error string.
        """
    ...
    def post_execution(
        ...
        Args:
            shared_context: The shared context dictionary.
            prepared_inputs: Data from `pre_execution`.
            execution_outputs: Markdown content of the review.
        """
        if prepared_inputs.get("skip", True):
